...
void usuario1(char a[N][N]){
    ...
    do{
        ...
        if((a[f-1][c-1] == 'O' && a[f-2][c-2] == 'X') || (a[f-1][c-1] == 'O' && a[f-2][c+1] == 'X') ||(a[f-1][c-1] == 'O' && a[f][c-1] == 'X'))
            a[f-1][c-1] = 'X';
        if((a[f-1][c] == 'O' && a[f-2][c] == 'X'))
            a[f-1][c] = 'X';
        if((a[f-1][c+1] == 'O' && a[f-2][c] == 'X') || (a[f-1][c+1] == 'O' && a[f][c+2] == 'X') || (a[f-1][c+1] == 'O' && a[f-2][c+2] == 'X'))
            a[f-1][c+1] = 'X';
        if((a[f][c-1] == 'O' && a[f][c-2] == 'X'))
            a[f][c-1] = 'X';
        if((a[f][c+1] == 'O' && a[f][c+2] == 'X'))
            a[f][c+1] = 'X';
        if((a[f+1][c-1] == 'O' && a[f][c-2] == 'X') || (a[f+1][c-1] == 'O' && a[f+2][c-2] == 'X') ||(a[f+1][c-1] == 'O' && a[f+2][c] == 'X'))
            a[f+1][c-1] = 'X';
        if((a[f+1][c] == 'O' && a[f+2][c] == 'X'))
            a[f+1][c] = 'X';
        if((a[f+1][c+1] == 'O' && a[f+2][c+2] == 'X') || (a[f+1][c+1] == 'O' && a[f+2][c] == 'X') || (a[f+1][c+1] == 'O' && a[f][c+2] == 'X'))
            a[f+1][c+1] = 'X';
...
void usuario2(char a[N][N]){
    ...
    do{
        ...
        if((a[f-1][c-1] == 'X' && a[f-2][c-2] == 'O') || (a[f-1][c-1] == 'X' && a[f-2][c+1] == 'O') ||(a[f-1][c-1] == 'X' && a[f][c-1] == 'O'))
            a[f-1][c-1] = 'O';
        if((a[f-1][c] == 'X' && a[f-2][c] == 'O'))
            a[f-1][c] = 'O';
        if((a[f-1][c+1] == 'X' && a[f-2][c] == 'O') || (a[f-1][c+1] == 'X' && a[f][c+2] == 'O') || (a[f-1][c+1] == 'X' && a[f-2][c+2] == 'O'))
            a[f-1][c+1] = 'O';
        if((a[f][c-1] == 'X' && a[f][c-2] == 'O'))
            a[f][c-1] = 'O';
        if((a[f][c+1] == 'X' && a[f][c+2] == 'O'))
            a[f][c+1] = 'O';
        if((a[f+1][c-1] == 'X' && a[f][c-2] == 'O') || (a[f+1][c-1] == 'X' && a[f+2][c-2] == 'O') ||(a[f+1][c-1] == 'X' && a[f+2][c] == 'O'))
            a[f+1][c-1] = 'O';
        if((a[f+1][c] == 'X' && a[f+2][c] == 'O'))
            a[f+1][c] = 'O';
        if((a[f+1][c+1] == 'X' && a[f+2][c+2] == 'O') || (a[f+1][c+1] == 'X' && a[f+2][c] == 'O') || (a[f+1][c+1] == 'X' && a[f][c+2] == 'O'))
            a[f+1][c+1] = 'O';
